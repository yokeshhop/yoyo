...
<body>
    <div class="container">
                ...
                <div class="social-login">
                    ...
                    <h3 style="color:white;">JioTv Login </h3>
<p style="color:white;">Note:- Login Without +91</p>
                </div>
                <div class="screen"> <br>
		...
		height:47px; border-radius:6px;">
                ...
                <div class="logsucc" style="color:white;"><b></b><?php echo $sign; ?></b></div>
            </div>
            ...
            <div class="screen__background">
               ...
               <a type="button" href="./index.php" style="background-color:white; text-decoration:none;" class="bubbly-button">Back To JioTv Web</a>
    </div>
